...
###Survival models. 
To estimate apparent survival, we fit our capture-resight data using a Cormack-Jolly-Seber model to fit the relationship between our covariate of interest (non-native plants) and chickadee survivorship, as well account for detection probability. Because transient individuals are not relevant to thehe local plant community and may bias our estimates low, we truncated our dataset to only include adults that were captured or resighted during the breeding season (March-June). 

Males are more conspicuous because of singing behavior, therefore we fit sex-specific detection and survival. To assess the effect of non-native landscaping, we included a term that represented the importance value of non-native trees and shrubs. We fit the model with a bayesian analysis using uninformative prior distributions for our unknown parameters. We performed Markov Monte Carlo simulations to estimate posterior distributions using JAGS () called by package "R2Jjags (XX) in program R(). We used 500.000 iterations wit ha burn-in of 50.000 iterations, a thinning rate of 1 and three chains. We assessed convergense by confirming that R^ was <1.0005 for all parameters estimated. We estimated posterior means, standard error and confidence intervals. 

###Population growth
We used the estimates obtained from the Aster Model and the apparent survival model to calculate female-centered population growth  (λ = 0.5*Rs*Ns*Js/1-As) across a gradient of non-native plant dominance. For each parameter we pulled a random number from a uniform distribution within the confidence interval calculated from the model from 0 to 100% non-native plants. From the Aster model, we used  0.5 times the predicted fledged young (to represent female fledglings) and the probability of the nest surviving. From teh CJS model, we used apparent survival of adult females. To account for juvenile survival we used the 22% survival estimate obtained from Dhondt (1979)for survival between June and September of great tits in Sweden. For each run of the population model we simulated the change in a population of 1000 individuals after t+1. To obtain a confidence interval around our growth estimates, we ran 10000 iterations. We plotted the mean population growth and confidence intervals across the non-native plant gradient. 
	 

#RESULTS	
##*Summary.*
Between 2013 and 2016, we collected plant data from 160 different sites that were monitored for chickadee breeding activity. From those sites, we located and monitored 224 chickadee nests at 91 sites. The mean number of fledglings per nest was 3.00 ± 2.58 SD however, a large proportion of sites (39%) did not produce any fledglings because no nest was ever initiated, despite chickadees being present at the area. Between 2000-2016, 2102 chickadees were captured at Neighborhood Nestwatch yards and 969 chickadees (table 1) were captured in XX yards with associated plant data. After truncating our dataset to local breeders, our apparent survival estimates were derived from the capture-resight of 686 individuals. 
...
#DISCUSSION
INTRO TO DISCUSSION
In novel landscapes like urban areas, the conservation value of non-native plants has been suggested (Schlaepfer et al 2011), especially when non-native species appear to provide habitat and resources to wildlife.  Few studies explicitly compare the habitat value provided by non-native and native plant species that were replaced. Here, we show that neighborhoods landscaped with non-native plants are poor habitat for insectivorous consumers because they negatively affect chickadee reproduction resulting in unsustainable populations.

REPRODUCTIVE RESULTS
Our results show that non-native plants reduce the reproductive potential of an insectivorous bird via bottom-up effects on territory quality. We found the strongest effets on both the behavioral choice to breed as well as the number of fledglings that were prooduced. 
...
SURVIVAL
We did not find an affect of non-native plants on survival for either males or females. For birds that spend the winter in temperate climates, food is the most limiting factor affecting survival (Danner eet al. XXXX). In addition, insectivorous birds still consume arthropods in the winter; for example, kinglets wintering in maine, over 90% of the insect material consmed was over-wintering lepidoptera. For our chickadee species, up to 50% of the winter diet is arthropod-based food (Narango unpublished data). Neighborhoods that are depauperate of insects during the breeding season are likely in more extreme conditions in the winter after months of predation and parasitism thereforechickadees are likely experiencing arthropod-food limitation in the winter. Howver, urbban areas  have conditions that may improve survival regardless of winter food. Chickadees may seek out warmer microclimates of urban areas to reduce the costs of overnight metabolism (XX). In addition, extreme popularity of bird-feeding in urban areas provides a near-continuous supply of seed-based food. Thus, any costs thhat are associed with loss of insects may be compensated by changes in behavior. 


POPULATION GROWTH
Our population growth  equation revealed that urban areas may not serve as source populations. In addition, our models suggested that at 25% non-native plants, neighborhoods are acting like sinks for chickadees.

Chickadees are a common backyardbird, but our models reveal that they are also a highly specialized species that is being negatively impacted by chnged in floral communities. Although this species appear abudnant, they are also limited by cavities, and new breeders are likely spillover from surronding productive forests that servce as reproductive sources. 
...
Homeowners prioritizing wildlife habitat should plant and retain native plants to encourage positive growth in insectivorous bird populations.
